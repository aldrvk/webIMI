                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="grid grid-cols-7 border-t border-l border-gray-200 dark:border-gray-700">
                                ...
                                <div class="text-center text-sm font-semibold text-gray-500 dark:text-gray-400 py-2 border-r border-b dark:border-gray-700">Sen</div>
                                <div class="text-center text-sm font-semibold text-gray-500 dark:text-gray-400 py-2 border-r border-b dark:border-gray-700">Sel</div>
                                <div class="text-center text-sm font-semibold text-gray-500 dark:text-gray-400 py-2 border-r border-b dark:border-gray-700">Rab</div>
                                <div class="text-center text-sm font-semibold text-gray-500 dark:text-gray-400 py-2 border-r border-b dark:border-gray-700">Kam</div>
                                <div class="text-center text-sm font-semibold text-gray-500 dark:text-gray-400 py-2 border-r border-b dark:border-gray-700">Jum</div>
                                <div class="text-center text-sm font-semibold text-gray-500 dark:text-gray-400 py-2 border-r border-b dark:border-gray-700">Sab</div>
                                <div class="text-center text-sm font-semibold text-gray-500 dark:text-gray-400 py-2 border-r border-b dark:border-gray-700">Min</div>
